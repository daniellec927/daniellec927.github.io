      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "News",handler: () => {
            ...
            },},{id: "projects-2026-march-madness-prediction",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/march_madness_project/";
            },},{id: "projects-todo-project-name",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/files/Danielle_Choi_CV.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/daniellec927", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
