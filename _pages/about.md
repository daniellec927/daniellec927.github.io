...
profile:
  align: right
  # Replace assets/img/prof_pic.jpg with your own photo, keeping the filename.
  image: prof_pic.jpg
...
announcements:
  enabled: true # short updates pulled from the _news folder
  scrollable: true # adds a scroll bar past 3 items
  limit: 5 # leave blank to show all
